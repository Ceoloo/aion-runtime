#!/usr/bin/env bash
# ============================================================================
# mission008-proof-matrix.sh — Mission 008 PASS A–G against live Runtime.
# ============================================================================
set -euo pipefail
cd "$(dirname "$0")/.."
ROOT="$(pwd)"
...
LOG="$ROOT/.proof-m008-runtime.log"
echo "[proof-m008] start Runtime"
...
wait_ready "$LOG"
echo "[proof-m008] Runtime ready"

echo "[proof-m008] PASS A–G"
AION_RUNTIME_URL="$AION_RUNTIME_URL" node dist/mission008-proof-matrix.js

echo "[proof-m008] PASS — Mission 008 matrix A–G green"
