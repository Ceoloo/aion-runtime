#!/usr/bin/env bash
# ============================================================================
# mission005-proof-matrix.sh — Mission 005 PASS A/B/C against live Runtime.
# ============================================================================
# Sequence:
#   migrate → boot Runtime → PASS A (mission economics match) →
#   PASS B (holding rollup + cross-tenant DENY) → PASS C (tenant header required)
#
# Required env: MIGRATION_DATABASE_URL, DATABASE_URL
# Optional: PORT (8095), DATABASE_SSL (false), GIT_SHA (local)
# ============================================================================
set -euo pipefail
cd "$(dirname "$0")/.."
ROOT="$(pwd)"
...
LOG="$ROOT/.proof-m005-runtime.log"

echo "[proof-m005] start Runtime"
...
wait_ready "$LOG"
echo "[proof-m005] Runtime ready"

echo "[proof-m005] PASS A/B/C"
AION_RUNTIME_URL="$AION_RUNTIME_URL" node dist/mission005-proof-matrix.js

echo "[proof-m005] PASS — Mission 005 matrix A/B/C green"
